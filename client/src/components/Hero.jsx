    ...
    return (
        ...
        >
            ...
            <div className="responsive-container mx-auto mt-5">
                <div className="flex flex-col lg:flex-row items-center gap-1 sm:gap-3 lg:gap-12 mobile-stack">

                    {/* LEFT */}
                    <div className="lg:w-1/2 mobile-full-width">
                        <h1 className="hidden sm:block responsive-heading-1 font-extrabold text-[#111827] leading-tight mb-4">
                        ...
                        <h5 className="hidden sm:block text-lg mb-7 text-[#111827]">
                            Sirf Smartphone + Internet se
                        </h5>

                        {/* Features */}
                        <div className="hidden sm:grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                            {[
                                "No Laptop Required",
                                ...
                                <div
                                    key={i}
                                    className="flex items-center gap-3 bg-white/70 backdrop-blur-md border p-4 rounded-2xl shadow-md"
                                >
                                    <span className="text-[#0092B9] text-2xl">✔</span>
                    ...
                    <div className="w-full lg:w-1/2 mobile-full-width">
                        ...
                        <h4 className="mx-auto mb-2 sm:mb-4 px-3 sm:px-4 py-1 rounded-full bg-[#0092B9]/10 text-[#0092B9] text-center text-base sm:text-xl font-bold w-fit">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8 lg:hidden">
                            {[
                                ...
                                <div
                                    key={i}
                                    className="flex items-center gap-3 bg-white/70 backdrop-blur-md p-4 rounded-2xl shadow-md"
                                >
                                    <span className="text-[#0092B9] text-2xl">✔</span>
                                    <span className="font-semibold text-[#111827]">
                                        {item}
