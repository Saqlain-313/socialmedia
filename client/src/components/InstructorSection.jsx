...
const InstructorSection = () => {
    return (
        <section id="about" className="py-8 md:py-12 bg-pattern">
            <div className="responsive-container mx-auto">
                ...
                <div className="flex flex-col lg:flex-row items-center gap-reduced mobile-stack">
                    ...
                    {/* Content Section */}
                    <div
                        className="lg:w-3/5 lg:pl-8 md:pl-12 mobile-full-width"
                        data-aos="fade-left"
                        data-aos-duration="1000"
                    >
                        <div className="bg-white rounded-3xl p-6 md:p-8 card-shadow mobile-padding">

                            <p className="text-base md:text-lg mb-4 md:mb-6 mobile-text-base text-[#111827]">
                                <strong>
                                    Hi, I'm Shahid,{" "}
                                    <span
                                        className="underline"
                            ...
                            <div className="p-4 md:p-6 rounded-2xl gradient-bg text-white mb-6 md:mb-8 mobile-padding">
